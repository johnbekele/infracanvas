...
export const awsServices: AWSService[] = [
  // Compute
  {
    ...
    properties: [
      { name: 'instanceName', label: 'Instance Name', type: 'text', default: 'my-instance', required: true },
      { name: 'instanceType', label: 'Instance Type', type: 'select', default: 't3.micro', options: [
      ...
      { name: 'ami', label: 'Operating System', type: 'select', default: 'amazon-linux-2023', options: [
      ...
      { name: 'rootVolumeType', label: 'Volume Type', type: 'select', default: 'gp3', options: [
  ...
  },
  {
    ...
    properties: [
      { name: 'functionName', label: 'Function Name', type: 'text', default: 'my-function', required: true },
      { name: 'runtime', label: 'Runtime', type: 'select', default: 'nodejs20.x', options: [
      ...
      { name: 'memory', label: 'Memory (MB)', type: 'select', default: '256', options: [
      ...
      { name: 'architecture', label: 'Architecture', type: 'select', default: 'arm64', options: [
  ...
  },
  {
    ...
    allowedConnections: ['rds', 'dynamodb', 's3', 'elasticache', 'sqs', 'sns', 'vpc', 'iam'],
    properties: [
      { name: 'clusterName', label: 'Cluster Name', type: 'text', default: 'my-cluster', required: true },
      { name: 'serviceName', label: 'Service Name', type: 'text', default: 'my-service', required: true },
      { name: 'launchType', label: 'Launch Type', type: 'select', default: 'FARGATE', options: [
        { value: 'FARGATE', label: 'Fargate (Serverless)' },
        { value: 'EC2', label: 'EC2' },
      ]},
      { name: 'cpu', label: 'CPU', type: 'select', default: '512', options: [
        { value: '256', label: '0.25 vCPU' },
        { value: '512', label: '0.5 vCPU' },
        { value: '1024', label: '1 vCPU' },
        { value: '2048', label: '2 vCPU' },
      ]},
      { name: 'memory', label: 'Memory', type: 'select', default: '1024', options: [
        { value: '512', label: '512 MB' },
        { value: '1024', label: '1 GB' },
        { value: '2048', label: '2 GB' },
  ...
  // Storage
  {
    ...
    properties: [
      { name: 'bucketName', label: 'Bucket Name', type: 'text', default: 'my-bucket', required: true },
      { name: 'versioning', label: 'Versioning', type: 'boolean', default: false },
      { name: 'encryption', label: 'Encryption', type: 'select', default: 'AES256', options: [
  ...
  // Database
  {
    ...
    properties: [
      { name: 'identifier', label: 'DB Identifier', type: 'text', default: 'my-database', required: true },
      { name: 'engine', label: 'Database Engine', type: 'select', default: 'postgres', options: [
      ...
      { name: 'instanceClass', label: 'Instance Class', type: 'select', default: 'db.t3.micro', options: [
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'billingMode', label: 'Billing Mode', type: 'select', default: 'PAY_PER_REQUEST', options: [
        { value: 'PAY_PER_REQUEST', label: 'On-Demand' },
        { value: 'PROVISIONED', label: 'Provisioned' },
      ]},
      { name: 'hashKey', label: 'Partition Key', type: 'text', default: 'id', required: true },
      { name: 'hashKeyType', label: 'Partition Key Type', type: 'select', default: 'S', options: [
      ...
      { name: 'pointInTimeRecovery', label: 'Point-in-Time Recovery', type: 'boolean', default: false },
    ],
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'engine', label: 'Engine', type: 'select', default: 'redis', options: [
        { value: 'redis', label: 'Redis 7.x' },
        { value: 'memcached', label: 'Memcached 1.6' },
      ]},
      { name: 'nodeType', label: 'Node Type', type: 'select', default: 'cache.t3.micro', options: [
  ...
  // Networking
  {
    ...
    properties: [
      ...
      { name: 'priceClass', label: 'Price Class', type: 'select', default: 'PriceClass_100', options: [
      ...
      { name: 'defaultRootObject', label: 'Default Root Object', type: 'text', default: 'index.html' },
      { name: 'defaultTtl', label: 'Default TTL (seconds)', type: 'number', default: 86400 },
      { name: 'viewerProtocol', label: 'Viewer Protocol Policy', type: 'select', default: 'redirect-to-https', options: [
  ...
  },
  {
    ...
    properties: [
      { name: 'domainName', label: 'Domain Name', type: 'text', default: 'example.com', required: true },
      { name: 'zoneType', label: 'Zone Type', type: 'select', default: 'public', options: [
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'cidrBlock', label: 'CIDR Block', type: 'text', default: '10.0.0.0/16', required: true },
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'apiType', label: 'API Type', type: 'select', default: 'HTTP', options: [
  ...
  // Security
  {
    ...
    properties: [
      ...
      { name: 'assumeRoleService', label: 'Trusted Service', type: 'select', default: 'lambda.amazonaws.com', options: [
        { value: 'lambda.amazonaws.com', label: 'Lambda' },
        { value: 'ec2.amazonaws.com', label: 'EC2' },
        { value: 'ecs-tasks.amazonaws.com', label: 'ECS Tasks' },
      ]},
      { name: 'managedPolicies', label: 'Managed Policies', type: 'textarea', default: 'arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole' },
    ],
  ...
  },
  {
    ...
    properties: [
      { name: 'poolName', label: 'User Pool Name', type: 'text', default: 'my-user-pool', required: true },
      { name: 'mfaConfiguration', label: 'MFA', type: 'select', default: 'OPTIONAL', options: [
        { value: 'OFF', label: 'Off' },
        { value: 'OPTIONAL', label: 'Optional' },
        { value: 'ON', label: 'Required' },
      ]},
      { name: 'usernameAttributes', label: 'Sign-in Method', type: 'select', default: 'email', options: [
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'visibilityTimeout', label: 'Visibility Timeout (seconds)', type: 'number', default: 30 },
      { name: 'messageRetention', label: 'Message Retention (seconds)', type: 'number', default: 345600 },
  ...
  },
  {
    ...
    properties: [
      { name: 'subnetName', label: 'Subnet Name', type: 'text', default: 'public-subnet', required: true },
      { name: 'cidrBlock', label: 'CIDR Block', type: 'text', default: '10.0.1.0/24' },
      { name: 'availabilityZone', label: 'Availability Zone', type: 'select', default: 'us-east-1a', options: [
  ...
  },
  {
    ...
    parentRequired: 'vpc-environment',
    properties: [
      { name: 'subnetName', label: 'Subnet Name', type: 'text', default: 'private-subnet', required: true },
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'internal', label: 'Internal', type: 'boolean', default: false },
      { name: 'enableCrossZone', label: 'Cross-Zone Load Balancing', type: 'boolean', default: true },
      { name: 'listenerPort', label: 'Listener Port', type: 'number', default: 80 },
    ],
    terraformResource: 'aws_lb',
    pulumiClass: 'aws.lb.LoadBalancer',
  },
  {
    ...
    properties: [
      ...
      { name: 'connectivityType', label: 'Connectivity Type', type: 'select', default: 'public', options: [
