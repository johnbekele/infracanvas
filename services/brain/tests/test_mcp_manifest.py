...
async def test_discover_reports_the_targeted_protocol_version(client: Client) -> None:
...
async def test_manifest_version_matches_the_discover_response(client: Client) -> None:
    result = await client.session.discover()
