    ...
    <div className="flex h-screen flex-col bg-gray-50 dark:bg-gray-950">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 overflow-y-auto px-4 py-8">
        <div className="mb-6 flex items-end justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Repositories</h1>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Connect a repository, analyse what it is built from, and generate an architecture for
              it.
            </p>
          </div>
